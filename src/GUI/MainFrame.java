...
public class MainFrame extends JFrame {
   ...
   // public static final int ALTEZZA_FRAME = 780;
    //public static final int LARGHEZZA_FRAME = 1025;  
    
    public static final int ALTEZZA_FRAME = 1000;
    public static final int LARGHEZZA_FRAME = 1125;
